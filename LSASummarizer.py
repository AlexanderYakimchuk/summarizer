...
# sanity check
print(summarize(
    "Полиция лишь сняла отпечатки пальцев и на этом всё. Теперь мой совет: чем больше нестандартных противоугоннок - тем лучше. Теперь мой совет: чем больше нестандартных противоугоннок - тем лучше. Теперь мой совет: чем больше нестандартных противоугоннок - тем лучше. Теперь мой совет: чем больше нестандартных противоугоннок - тем лучше.Теперь мой совет: чем больше нестандартных противоугоннок - тем лучше.Теперь мой совет: чем больше нестандартных противоугоннок - тем лучше.",
    'russian', 2))
print(summarize(
    "Його зупинила охорона і мешканці комплексу, з якими він вступив у бійку та погрожував. Після приїзду поліції нетверезий водій представився їм співробітником СБУ, помічником першого заступника Голови СБУ. Назвав своє прізвище - Саглай. Поліції пообіцяв, що все порєшає, і за водіння у нетверезому вигляді і умисне знищення майна йому абсолютно нічого не буде. Нічого не буде. Не буде. Нічого. ",
    'ukrainian', 2))
